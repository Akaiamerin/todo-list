...
<script setup>
import useData from '@/composables/use-data.js';
import useNewTodo from '@/composables/use-new-todo.js';
import useFilterData from '@/composables/use-filter-data.js';
import useDetail from '@/composables/use-detail.js';
const data = useData();
const newTodo = useNewTodo(data.dataListRef);
const filterData = useFilterData(data.dataListRef);
const detail = useDetail(data.dataListRef);
function handleTodoItemStatus(todoItem) {
...
function handleToggleAllStatus(event) {
...
function handleEditTodoItem(event, todoItem) {
    if (event.key === 'Enter') {
